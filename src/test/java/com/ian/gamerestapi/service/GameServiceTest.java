...
public class GameServiceTest {
    ...
    public void getGameTestInvalidIdString() {
        ResponseEntity<Object> response = gameService.getGame(INVALID_ID_STRING);
    ...
    public void getGameTestInvalidIdNegativeInt() {
        ResponseEntity<Object> response = gameService.getGame(INVALID_ID_NEGATIVE_INT);
    ...
    public void getGameTestValidId() {
        ResponseEntity<Object> response = gameService.getGame(VALID_ID);
        //TODO: Mock Repo
